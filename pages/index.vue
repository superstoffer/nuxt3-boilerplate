<template>
  <div>
    <p class="text-gray-800 text-4xl font-bold text-center">Welcome to Nuxt3 Starter Kit</p>
    <p class="text-center">This page can be deleted and replaced with actual data</p>
...
<div class="bg-white">
  <div class="mx-auto max-w-7xl py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
    <div class="mx-auto max-w-3xl text-center">
      <h2 class="text-3xl font-bold tracking-tight text-gray-900">Nuxt 3 Boilerplate</h2>
    ...
    <dl class="mt-12 space-y-10 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 sm:space-y-0 lg:grid-cols-4 lg:gap-x-8">
      <div class="relative">
        <dt>
          ...
          <p class="ml-9 text-lg font-medium leading-6 text-gray-900">Nuxt 3</p>
        </dt>
      ...
      <div class="relative">
        <dt>
          ...
          <p class="ml-9 text-lg font-medium leading-6 text-gray-900">Tailwind CSS</p>
        </dt>
      ...
      <div class="relative">
        <dt>
          ...
          <p class="ml-9 text-lg font-medium leading-6 text-gray-900">Tailwind CSS Forms Plugin</p>
        </dt>
